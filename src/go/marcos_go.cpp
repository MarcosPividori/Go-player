  ...
  for (int c = 1; c < argc; c++) {
    try {
      if (c < argc - 1 && !strcmp(argv[c], "--patterns"))
        ...
        std::cout << "usage: marcos_go [--patterns file]" << std::endl
                  << "                 [--bandit_coeff double]" << std::endl
                  << "                 [--amaf_coeff double]" << std::endl
                  << "                 [--fill_board double]" << std::endl
                  << "                 [--long_game_coeff double]" << std::endl
                  << "                 [--limit_expansion int]" << std::endl
                  << "                 [--cycles_mcts int]" << std::endl
                  << "                 [--threads_mcts int]" << std::endl
                  << "                 [--resign_limit double]" << std::endl
                  << "                 [--root_parallel]" << std::endl
                  << "                 [--japanese_rules]" << std::endl
                  << "                 [--totally_random_sim]" << std::endl
                  << "                 [--no_rave]" << std::endl
                  << "                 [--help]" << std::endl;
        return 0;
      } else {
